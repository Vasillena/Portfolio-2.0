...
export default function Player({ src }: PlayerProps) {
  ...
  //   const togglePlay = () => {
  //     if (!audioRef.current || !lottieRefLeft.current) return;
  ...
  return (
    //     <div className="absolute top-2 left-0 z-10 flex items-center justify-center">
    ...
    //         "
    //         //     className="
    //         //     w-6 h-6 absolute items-center justify-center
    //         //     hover:scale-105 transition
    //         //   "
    //       >
    //         {isPlaying ? (
    ...
    //         ) : (
    //           <PlayIcon className="w-auto h-4 invert brightness-100" />
    //         )}
    //       </button>
    //       <div
    //         className={`
    ...
    //           }}
    //           className="w-120 h-auto pointer-events-none"
    //         />
    //       </div>
    //     </div>
    <>
